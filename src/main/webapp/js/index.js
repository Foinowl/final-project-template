//TODO: когда-нибудь, скорее никогда,
// эту портянку разобью на html-template, добавлю mvc логику, вынесу отдельного предка
// для генерирования однотипных элементов...


//код писал "в лоб", лишь бы работало. Не стал проектировать и разбивать все на объекты, и взаимодействи между ними...
